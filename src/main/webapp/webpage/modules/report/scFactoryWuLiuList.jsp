                        ...
                        <table class="table table-bordered" style="margin-bottom: 0;">
                            ...
                            <tr>
                                <td class="width-label active" >
                                    <label for="logisticsName" class="pull-right" title="物流公司">物流公司：</label>
                                </td>
                                <td class="width-value">
                                    <input name="logisticsName" type="text" id="logisticsName" maxlength="64" class=" form-control"/>
                                </td>
                            ...
                            <tr>
                                <td class="width-label active"><label class="pull-right" for="status">状态：</label></td>
                                <td class="width-value">
                                ...
                                <td class="width-label active" colspan="2">
...
<%@include file="scFactoryWuLiuList_js.jsp"%>
