...
<script>
    ...
    $(document).ready(function () {
        ...
        function onEditableSaveForOrder(_field, _row, _rowIndex, _oldValue, _$el) {
            ...
            // ajax 请求保存数据
            // console.log(data);
            jp.post('${ctx}/report/scReport/saveFactoryWuLiuPayPrice', _row, function (result) {
        ...
        $('#scOrderTable').bootstrapTable({
            ...
            url: "${ctx}/report/scReport/findFactoryWuLiuReportList",
    ...
    function detailFormatter(index, row) {
        ...
        $.get("${ctx}/report/scReport/findFactoryWuLiuItemReportList?&date="+row.logistics_date+'&logisticsName='+row.logistics_name, function (data) {
