...
<head>
    ...
    <link href="${ctxStatic}/plugin/bootstrap3-editable/css/bootstrap-editable.css" rel="stylesheet">
    <script src="${ctxStatic}/plugin/bootstrap-table/bootstrap-table.js"></script>
    <script src="${ctxStatic}/plugin/bootstrap-table/locale/bootstrap-table-zh-CN.js"></script>
    <script src="${ctxStatic}/plugin/bootstrap-table/extensions/export/bootstrap-table-export.js"></script>
    ...
    <script src="${ctxStatic}/plugin/bootstrap-table/extensions/editable/bootstrap-table-editable.js"></script>
    <script src="${ctxStatic}/plugin/bootstrap3-editable/js/bootstrap-editable.js"></script>
</head>
<body>
...
<%--                <shiro:hasPermission name="order:scOrder:tableSetting">--%>
