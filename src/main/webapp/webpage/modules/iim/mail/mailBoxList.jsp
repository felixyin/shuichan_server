        ...
        <div class="col-sm-9 animated fadeInRight">
            <div class="mail-box-header">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <form:form id="searchForm" modelAttribute="mailBox" action="${ctx}/iim/mailBox/" method="post"
                                   class="pull-right mail-search">
                            <input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
                            <input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
                            <table:sortColumn id="orderBy" name="orderBy" value="${page.orderBy}"
                                              callback="sortOrRefresh();"></table:sortColumn><!-- 支持排序 -->
                            <div class="input-group">
                                <form:input path="mail.title" htmlEscape="false" maxlength="128" class=" form-control"
                ...
                <div class="mail-tools tooltip-demo m-t-md">
                    ...
                    <button class="btn btn-primary  " data-toggle="tooltip" data-placement="left" onclick="sortOrRefresh()" title="刷新邮件列表">
                        <i class="fa fa-refresh"></i> 刷新
                    </button>
                    <button class="btn btn-default  " data-toggle="tooltip" data-placement="top" title="标为已读"><i class="fa fa-eye"></i>
                    </button>
                    <button class="btn btn-default " data-toggle="tooltip" data-placement="top" title="标为重要"><i
                ...
                <table id="contentTable" class="table table-hover">
                    ...
                    <c:forEach items="${page.list}" var="mailBox">
                        <tr>
                            ...
                            <td>
                                <a href="${ctx}/iim/mailBox/delete?id=${mailBox.id}" onclick="return jp.confirm('确认要删除该站内信吗？', this.href)"
                                   class="btn btn-info btn-xs btn-danger"><i class="fa fa-trash"></i> 删除</a>
                            </td>
                        </tr>
                    </c:forEach>
