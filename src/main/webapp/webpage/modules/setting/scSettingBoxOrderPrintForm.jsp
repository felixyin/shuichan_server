	...
	<script type="text/javascript">
		...
		function save() {
            ...
            if(!isValidate){
                ...
                jp.loading();
                jp.post("${ctx}/setting/scSettingBoxOrderPrint/save",$('#inputForm').serialize(),function(data){
                    if(data.success){
...
<body class="bg-white">
		<form:form id="inputForm" modelAttribute="scSettingBoxOrderPrint" class="form-horizontal">
		<form:hidden path="id"/>	
