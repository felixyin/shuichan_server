...
<body>
	...
	<div class="row">
		...
		<div class="${isAdmin?'col-md-9':'col-md-12'} animated fadeInRight">
			<!-- 搜索框-->
	    ...
	    <div id="toolbar">
	    	...
	    	<shiro:hasPermission name="sys:user:add">
	    		<a id="add" class="btn btn-primary"  onclick="jp.openSaveDialog('新建用户', '${ctx}/sys/user/form','800px', '560px')"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
