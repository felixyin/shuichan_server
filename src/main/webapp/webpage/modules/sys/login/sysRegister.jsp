...
<div class="login-page">
    <div class="row">
        <div class="col-md-4 col-lg-4 col-md-offset-4 col-lg-offset-4">
            <img class="img-circle" src="${ctxStatic}/common/images/logo.jpg" class="user-avatar"/>
            <h1>佰安客工厂管理系统</h1>
            <br>
            <h4>注意事项：仅支持注册工厂管理员账号 <br/>其他账号由工厂管理员登录系统后管理<%-- <br/>注册问题咨询：18561506161（魏经理）--%></h4>
            <sys:message content="${message}" showType="1"/>
            <form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/register/registerUser" method="post"
                       class="form-group form-horizontal">
                <input type="hidden" value="scadmin" name="roleName"><!-- 默认注册用户都是网吧管理员 -->
                <div class="form-content">
                    <div class="form-group">
                        <input id="factory" name="factoryName" type="text" value="" maxlength="21" minlength="2"
                               class="form-control input-underline input-lg required " placeholder="水产加工厂全称"/>
                    </div>
                    <div class="form-group">
                        <input id="tel" name="mobile" type="text" value="" maxlength="11" minlength="11"
                               class="form-control input-underline input-lg required isMobile" placeholder="管理员手机号"/>
                    </div>

<%--                    <div class=" form-group">--%>
<%--                        <div class="col-sm-9">--%>
<%--                            <input id="code" name="randomCode" type="text" value="" maxlength="4" minlength="4"--%>
<%--                                   class="form-control input-underline input-lg required" placeholder="验证码"/>--%>
<%--                        </div>--%>
<%--                        <div class="col-sm-3">--%>
...
<%--                    </div>--%>
                    <div class="form-group">
                        <input id="userId" name="loginName" type="text" value="${user.loginName }" maxlength="20" minlength="3"
                               class="form-control input-underline input-lg required" placeholder="管理员登录用户名"/>
                    </div>
                    <div class="form-group">

                        <input id="newPassword" name="password" type="password" value="" maxlength="20" minlength="3"
                               class="form-control input-underline input-lg required" placeholder="登录密码"/>
                    </div>
                    <div class="form-group">
                        <input id="confirmNewPassword" name="confirmNewPassword" type="password" value="" maxlength="20" minlength="3"
                               class="form-control input-underline input-lg required" equalTo="#newPassword" placeholder="重复密码"/>
                    </div>
                    <div class="form-group">
...
<%--                            <input name="ck1" type="checkbox"/>--%>
                            <span class="lbl">
										注册即接受用户协议
										<a href="#" onclick="jp.openViewDialog('用户注册协议','${pageContext.request.contextPath}/static/agreement.html','700px','80%');"><font color="white">《佰安客工厂管理系统用户注册协议》</font></a>
									</span>
                            <label id="ck1-error" class="error" for="ck1" style="display: none;">注册即接受用户协议</label>
                        </label>
