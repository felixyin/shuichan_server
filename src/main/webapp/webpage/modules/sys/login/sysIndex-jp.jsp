...
<nav class="navbar navbar-inverse display-default opnav-navbar navbar-fixed-top" role="navigation">
	<div class="topnav-navbar">
		<div class="navbar-header text-center">
			...
			<a class="navbar-brand J_menuItem" href="${ctx}/home" data-index="0">佰安客工厂管理系统</a>
		</div>
	</div>
	<div class="navbar-container container-fluid">
		<div class="collapse navbar-collapse navbar-collapse-toolbar row" id="jpMenu">
			<ul id="o1" class="nav navbar-toolbar nav-tabs  navbar-left" style="width: calc( 100% - 750px)" role="tablist">
...
<%--								<a href="javascript:;" class="active J_menuTab" data-id="${ctx}/home">首页</a>--%>
	...
	<div class="footer">
		<div class="text-center"><a href="http://www.qdbak.com" target="_blank">http://www.qdbak.com</a> &copy; 2019-2025</div>
	</div>
...
<script>
    ...
    $(function ($) {
		...
		$('#sidebar-nav>.tab-pane a:first').click();
