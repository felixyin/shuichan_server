	...
	<script type="text/javascript">
		...
		function save() {
            ...
            if(!isValidate){
                ...
                jp.loading();
                jp.post("${ctx}/custom/scCustom/save",$('#inputForm').serialize(),function(data){
                    if(data.success){
...
<body class="bg-white">
		<form:form id="inputForm" modelAttribute="scCustom" class="form-horizontal">
		<form:hidden path="id"/>	
		<table class="table table-bordered">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="address" htmlEscape="false"    class="form-control required stringCheck"/>
					</td>
