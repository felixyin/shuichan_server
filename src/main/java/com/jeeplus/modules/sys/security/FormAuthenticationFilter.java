    ...
    protected void issueSuccessRedirect(ServletRequest request,
        ...
        if (p != null) {
            if (!p.isMobileLogin()) {
                ...
                j.put("officeName", officeDirectly.getName());
                String roleName = "非包装员和快递员角色";
                // 1 加工厂
                if ("1".equals(officeDirectly.getType())) {
                    roleName = "包装员角色";
                    // 2 物流公司
                } else if ("2".equals(officeDirectly.getType())) {
                    roleName = "快递员角色";
                }
                j.put("roleName", roleName);
